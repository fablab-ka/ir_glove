...
void displayMenu() {
  Serial.println("GloveIR menu");
  Serial.println("*********************");
  for (int i = 0; i < COUNT; i++) {
    Serial.print("Code ");
    Serial.print(i);
    Serial.print(" für den ");
    Serial.print(vinger[i]);
    Serial.print(": ");
    Serial.println(codeValue[i], HEX);
  }
  Serial.println("Gib eine Ziffer ein, um einen Code einzulernen");
  Serial.println();
}
...
void processCommand(int code) {
  Serial.println("Halte die Fernbedienung vor den Emppfänger und drücke den Knopf");
  do {
    delay(1000);
